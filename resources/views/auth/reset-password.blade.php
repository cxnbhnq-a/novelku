...
<head>
    ...
    <title>Reset Password - NovelKu</title>
    <style>
        /* TEMA GLOBAL */
        :root {
            --bg-color: #f4f6f8;
...
<body>
    ...
    <div class="auth-card">
        ...
        <p class="form-description">Buat password baru yang kuat untuk akun Anda.</p>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <input type="email" id="email" name="email" value="{{ old('email', $request->email) }}" placeholder="Email Anda" required autocomplete="username">

            <label for="password">Password Baru</label>
            <input type="password" id="password" name="password" placeholder="Password minimal 10 karakter" required autocomplete="new-password">
